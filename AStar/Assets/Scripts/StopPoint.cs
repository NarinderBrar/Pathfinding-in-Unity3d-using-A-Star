...
{
  /// <summary>
  /// We will have only two variables for our StopPoint. 
  /// One will be the location, and the other will be 
  /// the name of the StopPoint. Note that these two variables 
  ...
  public static float GetManhattanCost(StopPoint a,StopPoint b)
  {
  ...
  public static float GetCostBetweenTwoStops(StopPoint a,StopPoint b)
  {
    return (a.Point - b.Point).magnitude;
  }
