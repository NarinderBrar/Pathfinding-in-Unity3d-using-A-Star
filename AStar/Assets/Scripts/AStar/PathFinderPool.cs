...
{
	private List<ThreadedPathFinder<T>> mPathFinders = new List<ThreadedPathFinder<T>>();

	public ThreadedPathFinder<T>CreateThreadedAStarPathFinder()
	{
		ThreadedPathFinder<T> tpf = new ThreadedPathFinder<T>(new AStarPathFinder<T>(), mPathFinders.Count );
	...
	public void FindPath(ThreadedPathFinder<T> tpf, Node<T> start, Node<T> goal )
	{
	...
	public void FindPath( int index, Node<T> start,Node<T> goal )
	{
