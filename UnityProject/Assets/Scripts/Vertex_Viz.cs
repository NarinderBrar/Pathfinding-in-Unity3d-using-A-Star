...
public class Vertex_Viz : MonoBehaviour
{
  ...
  public void SetVertex(Graph<BusStop>.Vertex vertex)
  {
    ...
    for (int i = 0; i < mVertex.Neighbours.Count; ++i)
    {
      ...
      Vector3 a = new Vector3(mVertex.Value.Point.x, mVertex.Value.Point.y, mVertex.Value.Point.z);
      Vector3 b = new Vector3(n.Value.Point.x, n.Value.Point.y, n.Value.Point.z);
